...
export default function ProjectPageClient({ id }: { id: string }) {
  ...
  return (
    <main className="relative min-h-screen bg-black text-white px-6 md:px-10 py-10 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(76,29,149,0.35),transparent_45%),radial-gradient(circle_at_80%_10%,rgba(14,116,144,0.35),transparent_40%),radial-gradient(circle_at_60%_80%,rgba(234,88,12,0.25),transparent_45%),radial-gradient(circle_at_10%_90%,rgba(16,185,129,0.18),transparent_40%)] z-0" />
      <div className="absolute inset-0 bg-gradient-to-b from-[#050505]/70 via-black/80 to-[#0a0600] z-0" />
      <div className="absolute inset-0 opacity-40 bg-[linear-gradient(120deg,rgba(255,255,255,0.06),transparent_30%,rgba(255,255,255,0.08),transparent_65%)] z-0" />
      <div className="absolute inset-0 opacity-[0.08] bg-[radial-gradient(rgba(255,255,255,0.9)_1px,transparent_1px)] [background-size:22px_22px] z-0" />
              ...
              <div className="rounded-2xl p-6 glass-panel">
                <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        downloadText("preroll-response.txt", rest || output)
                      }
                      className="text-xs text-white/70 hover:text-white px-3 py-1.5 rounded-lg glass-outline transition-colors"
                    >
                      Download Response
                  ...
                  <div className="whitespace-pre-wrap text-sm text-white/85 font-sans leading-relaxed">
                    {output.split(/\r?\n/).map((line, index) => (
                      <p
                        ...
                        className={headingIdForLine(line) ? "scroll-mt-24" : undefined}
                      >
                        {isHeadingLine(line) ? (
